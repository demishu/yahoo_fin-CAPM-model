...
class Meta_output_class:
    def set_writer(self,output_path):
    ...
    def set_columns_width(self, df, sheet):
        print("正在设置列宽")
        df = pd.DataFrame(df)
...
if __name__=='__main__':
    ...
    ticker_list = list() #这里输入你的股票代码列表就行。比如说AAPL代表苹果，MSFT代表微软， ["^IXIC",'AAPL',"MSFT"]就会爬纳斯达克100、苹果和微软。
